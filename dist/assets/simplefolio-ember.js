...
;define("simplefolio-ember/utils/data", ["exports"], function (_exports) {
  ...
  const projects = [{
    name: 'Reeltea',
    description: [`A Webapp where you can express your self about your favorite moments in Reality Tv-shows The app has been built using the following tools:
			Rails
			Postgresql
			Cloudinary
			Bootstrap
    ...
    name: 'Project Title',
    description: [`A CSS Linter with the purpose to check for spacing, indentation and format errors. Built with Ruby.`],
    ...
    name: 'Tea E-store',
    description: [`devlopment of the flower shop and holiday bouquets. A bright color scheme,
...
;define('simplefolio-ember/config/environment', [], function() {
          ...
          var exports = {
            'default': {"modulePrefix":"simplefolio-ember","environment":"development","rootURL":"/","locationType":"auto","EmberENV":{"FEATURES":{},"EXTEND_PROTOTYPES":{"Date":false},"_APPLICATION_TEMPLATE_WRAPPER":false,"_DEFAULT_ASYNC_OBSERVERS":true,"_JQUERY_INTEGRATION":false,"_TEMPLATE_ONLY_GLIMMER_COMPONENTS":true},"APP":{"name":"simplefolio-ember","version":"1.0.0+b73bed28"},"fontawesome":{"icons":{"free-brands-svg-icons":["twitter","codepen","linkedin","github"],"free-solid-svg-icons":["angle-up"]}},"ember-a11y-testing":{"componentOptions":{"turnAuditOff":true}},"exportApplicationGlobal":true}
          };
...
;
          if (!runningTests) {
            require("simplefolio-ember/app")["default"].create({"name":"simplefolio-ember","version":"1.0.0+b73bed28"});
          }
