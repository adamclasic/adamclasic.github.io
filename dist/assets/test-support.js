...
define("ember-a11y-testing/test-support/audit-if", ["exports", "ember-a11y-testing/test-support/audit", "ember-a11y-testing/test-support/utils"], function (_exports, _audit, _utils) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.default = a11yAuditIf;
  ...
  function getUrlParameter(name) {
    const location = _utils.default.getLocation();
  ...
  function a11yAuditIf(...args) {
    if (getUrlParameter('enableA11yAudit') === 'true') {
      return (0, _audit.default)(...args);
    }

    return Ember.RSVP.resolve(undefined, 'a11y audit not run');
  }
});
define("ember-a11y-testing/test-support/audit", ["exports", "ember-get-config", "ember-a11y-testing/utils/format-violation", "ember-a11y-testing/utils/violations-helper", "ember-a11y-testing/test-support/utils"], function (_exports, _emberGetConfig, _formatViolation, _violationsHelper, _utils) {
  "use strict";
  ...
  function a11yAuditCallback(results) {
    ...
    if (violations.length) {
      ...
      for (let i = 0, l = violations.length; i < l; i++) {
        ...
        let violationMessage = (0, _formatViolation.default)(violation, violationNodes);
      ...
      (true && !(false) && Ember.assert(`The page should have no accessibility violations. Violations:\n${allViolationMessages}`));
    }
  }
  /**
  ...
  function runA11yAudit(contextSelector = '#ember-testing-container', axeOptions) {
    (0, _utils.mark)('a11y_audit_start'); // Support passing axeOptions as a single argument
    ...
    if (!axeOptions) {
      ...
      let a11yConfig = _emberGetConfig.default['ember-a11y-testing'] || {};
    ...
    let auditPromise = new Ember.RSVP.Promise((resolve, reject) => {
    ...
    return auditPromise.then(a11yAuditCallback).finally(() => {
      ...
      (0, _utils.markEndAndMeasure)('a11y_audit', 'a11y_audit_start', 'a11y_audit_end');
    });
  }
  /**
...
define("ember-a11y-testing/test-support/utils", ["exports"], function (_exports) {
  "use strict";
...
/***/ "../../../../../tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js":
/*!**********************************************************************!*\
  !*** /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js ***!
  \**********************************************************************/
...
eval("\nwindow._eai_r = require;\nwindow._eai_d = define;\n\n\n//# sourceURL=webpack://__ember_auto_import__//tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js?");

/***/ }),

/***/ "../../../../../tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js":
/*!**************************************************************************!*\
  !*** /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js ***!
  \**************************************************************************/
/*! no static exports found */
...
eval("\nif (typeof document !== 'undefined') {\n  __webpack_require__.p = (function(){\n    var scripts = document.querySelectorAll('script');\n    return scripts[scripts.length - 1].src.replace(/\\/[^/]*$/, '/');\n  })();\n}\n\nmodule.exports = (function(){\n  var d = _eai_d;\n  var r = _eai_r;\n  window.emberAutoImportDynamic = function(specifier) {\n    return r('_eai_dyn_' + specifier);\n  };\n})();\n\n\n//# sourceURL=webpack://__ember_auto_import__//tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js?");

/***/ }),

/***/ 1:
/*!***********************************************************************************************************************************************!*\
  !*** multi /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js ***!
  \***********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js */\"../../../../../tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js\");\nmodule.exports = __webpack_require__(/*! /tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js */\"../../../../../tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js\");\n\n\n//# sourceURL=webpack://__ember_auto_import__/multi_/tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/l.js_/tmp/broccoli-17793IDYPV6F34Orh/cache-297-bundler/staging/tests.js?");
